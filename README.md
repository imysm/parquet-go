...
[![Travis Status for imysm/parquet-go](https://app.travis-ci.com/imysm/parquet-go.svg?branch=master)](https://app.travis-ci.com/github/imysm/parquet-go)
[![godoc for imysm/parquet-go](https://pkg.go.dev/badge/github.com/imysm/parquet-go.svg)](https://pkg.go.dev/github.com/imysm/parquet-go)
...
```sh
go get github.com/imysm/parquet-go
```
...
```sh
cd $GOPATH/src/github.com/imysm/parquet-go/example
...
|INT32|int32|
|INT64|int64|
|INT96([deprecated](https://github.com/imysm/parquet-go/issues/420))|string|
|FLOAT|float32|
|DOUBLE|float64|
|BYTE_ARRAY|string|
...
* Some type convert functions: [converter.go](https://github.com/imysm/parquet-go/blob/master/types/converter.go)
...
Using this interface, parquet-go can read/write parquet file on different platforms. Built-in file sources are available in the `source/` package: `local`, `buffer`, `writerfile`, `s3`.
...
[Example of ParquetWriter](https://github.com/imysm/parquet-go/blob/master/example/local_flat.go)

* JSONWriter is used to write JSON strings
[Example of JSONWriter](https://github.com/imysm/parquet-go/blob/master/example/json_write.go)

* CSVWriter is used to write data format similar with CSV(not nested)
[Example of CSVWriter](https://github.com/imysm/parquet-go/blob/master/example/csv_write.go)

* ArrowWriter is used to write parquet files using Arrow Schemas
[Example of ArrowWriter](https://github.com/imysm/parquet-go/blob/master/example/arrow_to_parquet.go)
...
[Example of ParquetReader](https://github.com/imysm/parquet-go/blob/master/example/local_nested.go)
...
[Example of ColumnReader](https://github.com/imysm/parquet-go/blob/master/example/column_read.go)
...
[Example of tags](https://github.com/imysm/parquet-go/blob/master/example/local_flat.go)
...
`
```
[Example of JSON schema](https://github.com/imysm/parquet-go/blob/master/example/json_schema.go)
...
[Example of CSV metadata](https://github.com/imysm/parquet-go/blob/master/example/csv_write.go)
...
[Example of Arrow metadata](https://github.com/imysm/parquet-go/blob/master/example/arrow_to_parquet.go)
...
2. `PARGO_PREFIX_` is a reserved string, which you'd better not use it as a name prefix. ([#294](https://github.com/imysm/parquet-go/issues/294))
3. Use `\x01` as the delimiter of fields to support `.` in some field name.([dot_in_name.go](https://github.com/imysm/parquet-go/blob/master/example/dot_in_name.go), [#349](https://github.com/imysm/parquet-go/issues/349)) 
...
|-|-|
|[local_flat.go](https://github.com/imysm/parquet-go/blob/master/example/local_flat.go)|write/read parquet file with no nested struct|
|[local_nested.go](https://github.com/imysm/parquet-go/blob/master/example/local_nested.go)|write/read parquet file with nested struct|
|[read_partial.go](https://github.com/imysm/parquet-go/blob/master/example/read_partial.go)|read partial fields from a parquet file|
|[read_partial2.go](https://github.com/imysm/parquet-go/blob/master/example/read_partial2.go)|read sub-struct from a parquet file|
|[read_without_schema_predefined.go](https://github.com/imysm/parquet-go/blob/master/example/read_without_schema_predefined.go)|read a parquet file and no struct/schema predefined needed|
|[read_partial_without_schema_predefined.go](https://github.com/imysm/parquet-go/blob/master/example/read_partial_without_schema_predefined.go)|read sub-struct from a parquet file and no struct/schema predefined needed|
|[json_schema.go](https://github.com/imysm/parquet-go/blob/master/example/json_schema.go)|define schema using json string|
|[json_write.go](https://github.com/imysm/parquet-go/blob/master/example/json_write.go)|convert json to parquet|
|[convert_to_json.go](https://github.com/imysm/parquet-go/blob/master/example/convert_to_json.go)|convert parquet to json|
|[csv_write.go](https://github.com/imysm/parquet-go/blob/master/example/csv_write.go)|special csv writer|
|[column_read.go](https://github.com/imysm/parquet-go/blob/master/example/column_read.go)|read raw column data and return value,repetitionLevel,definitionLevel|
|[type.go](https://github.com/imysm/parquet-go/blob/master/example/type.go)|example for schema of types|
|[type_alias.go](https://github.com/imysm/parquet-go/blob/master/example/type_alias.go)|example for type alias|
|[writer.go](https://github.com/imysm/parquet-go/blob/master/example/writer.go)|create ParquetWriter from io.Writer|
|[keyvalue_metadata.go](https://github.com/imysm/parquet-go/blob/master/example/keyvalue_metadata.go)|write keyvalue metadata|
|[dot_in_name.go](https://github.com/imysm/parquet-go/blob/master/example/dot_in_name.go)|`.` in filed name|
|[arrow_to_parquet.go](https://github.com/imysm/parquet-go/blob/master/example/arrow_to_parquet.go)|write/read parquet file using arrow definition|



## Tool

* [parquet-tools](https://github.com/imysm/parquet-go/blob/master/tool/parquet-tools): Command line tools that aid in the inspection of Parquet files
